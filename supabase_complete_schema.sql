...
---
-- ========================================
-- SUPABASE FRIENDLY PLAYER REGISTRATIONS (FOCUSED REGISTRATION TABLE)
-- This table is for the registration form in your React app
-- ========================================
...
-- Index for the Supabase registration table
...
-- Insert Sample Registrations for the form table
...
('Priya Singh', 25, '9876543212', 'Sankalp 1', 'A', '103'),
('Suresh Kumar', 30, '9876543213', 'Sankalp 1', 'B', '104'),
('Anita Gupta', 26, '9876543214', 'Sankalp 2', 'A', '205')
...
---
-- ========================================
-- COMPLETED: Database schema ready!
-- ========================================